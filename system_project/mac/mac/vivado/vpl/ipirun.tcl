...
set kernel_ip_dirs [list \
 "$vpp_link_root/int/xo/ip_repo/xilinx_com_hls_mac_1_0"]
...
set hw_platform_info [dict create \
  ...
  hw_platform_file             "/tools/Xilinx/Vitis/2023.1/base_platforms/xilinx_vck190_base_202310_1/hw/hw.xsa" \
  hw_platform_part             "xcvc1902-vsva2197-2MP-e-S" \
  hw_platform_vbnv             "xilinx.com:xd:xilinx_vck190_base_202310_1:202310.1" \
  bb_locked_dcp                "" \
  bb_synth_dcp                 "" \
  ...
  hw_platform_board_part       "xilinx.com:vck190:part0:3.2" \
  link_output_format           "pdi" \
  xpfm_file                    "/tools/Xilinx/Vitis/2023.1/base_platforms/xilinx_vck190_base_202310_1/xilinx_vck190_base_202310_1.xpfm" \
...
set config_info [dict create \
  ...
  run_script_map_file      "" \
  clbinary_name            "binary_container" \
  kernels                  "mac" \
  steps_log                 $steps_log \
  impl_from_step           "" \
  impl_to_step             "" \
