...
HD_PWD='/home/ubuntu/Desktop/dsp_recon/system_project/mac/mac/vivado/vpl/prj/prj.runs/vitis_design_icn_ctrl_5_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vitis_design_icn_ctrl_5_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vitis_design_icn_ctrl_5_0.tcl
