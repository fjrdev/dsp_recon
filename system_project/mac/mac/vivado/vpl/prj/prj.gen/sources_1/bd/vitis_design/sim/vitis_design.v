...
(* CORE_GENERATION_INFO = "vitis_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=vitis_design,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=28,numReposBlks=28,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=1,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=Vitis,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "vitis_design.hwdef" *) 
module vitis_design
   (ch0_lpddr4_c0_ca_a,
    ch0_lpddr4_c0_ca_b,
  ...
  wire clk_wizard_0_clk_out4;
  wire clk_wizard_0_clk_out5;
  wire clk_wizard_0_clk_out6;
  wire clk_wizard_0_clk_out7;
  ...
  wire mac_1_interrupt;
  wire [63:0]mac_1_m_axi_gmem_ARADDR;
  wire [1:0]mac_1_m_axi_gmem_ARBURST;
  wire [3:0]mac_1_m_axi_gmem_ARCACHE;
  wire [0:0]mac_1_m_axi_gmem_ARID;
  wire [7:0]mac_1_m_axi_gmem_ARLEN;
  wire [1:0]mac_1_m_axi_gmem_ARLOCK;
  wire [2:0]mac_1_m_axi_gmem_ARPROT;
  wire [3:0]mac_1_m_axi_gmem_ARQOS;
  wire [0:0]mac_1_m_axi_gmem_ARREADY;
  wire [3:0]mac_1_m_axi_gmem_ARREGION;
  wire [2:0]mac_1_m_axi_gmem_ARSIZE;
  wire mac_1_m_axi_gmem_ARVALID;
  wire [63:0]mac_1_m_axi_gmem_AWADDR;
  wire [1:0]mac_1_m_axi_gmem_AWBURST;
  wire [3:0]mac_1_m_axi_gmem_AWCACHE;
  wire [0:0]mac_1_m_axi_gmem_AWID;
  wire [7:0]mac_1_m_axi_gmem_AWLEN;
  wire [1:0]mac_1_m_axi_gmem_AWLOCK;
  wire [2:0]mac_1_m_axi_gmem_AWPROT;
  wire [3:0]mac_1_m_axi_gmem_AWQOS;
  wire [0:0]mac_1_m_axi_gmem_AWREADY;
  wire [3:0]mac_1_m_axi_gmem_AWREGION;
  wire [2:0]mac_1_m_axi_gmem_AWSIZE;
  wire mac_1_m_axi_gmem_AWVALID;
  wire [0:0]mac_1_m_axi_gmem_BID;
  wire mac_1_m_axi_gmem_BREADY;
  wire [1:0]mac_1_m_axi_gmem_BRESP;
  wire [0:0]mac_1_m_axi_gmem_BVALID;
  wire [31:0]mac_1_m_axi_gmem_RDATA;
  wire [0:0]mac_1_m_axi_gmem_RID;
  wire [0:0]mac_1_m_axi_gmem_RLAST;
  wire mac_1_m_axi_gmem_RREADY;
  wire [1:0]mac_1_m_axi_gmem_RRESP;
  wire [0:0]mac_1_m_axi_gmem_RVALID;
  wire [31:0]mac_1_m_axi_gmem_WDATA;
  wire mac_1_m_axi_gmem_WLAST;
  wire [0:0]mac_1_m_axi_gmem_WREADY;
  wire [3:0]mac_1_m_axi_gmem_WSTRB;
  wire mac_1_m_axi_gmem_WVALID;
  ...
  vitis_design_clk_wizard_0_0 clk_wizard_0
       (.clk_in1(CIPS_0_pl_clk0),
        ...
        .clk_out4(clk_wizard_0_clk_out4),
        .clk_out5(clk_wizard_0_clk_out5),
        .clk_out6(clk_wizard_0_clk_out6),
        .clk_out7(clk_wizard_0_clk_out7),
  ...
  vitis_design_mac_1_0 mac_1
       (.ap_clk(clk_wizard_0_clk_out3),
        .ap_rst_n(psr_312mhz_peripheral_aresetn),
        .interrupt(mac_1_interrupt),
        .m_axi_gmem_ARADDR(mac_1_m_axi_gmem_ARADDR),
        .m_axi_gmem_ARBURST(mac_1_m_axi_gmem_ARBURST),
        .m_axi_gmem_ARCACHE(mac_1_m_axi_gmem_ARCACHE),
        .m_axi_gmem_ARID(mac_1_m_axi_gmem_ARID),
        .m_axi_gmem_ARLEN(mac_1_m_axi_gmem_ARLEN),
        .m_axi_gmem_ARLOCK(mac_1_m_axi_gmem_ARLOCK),
        .m_axi_gmem_ARPROT(mac_1_m_axi_gmem_ARPROT),
        .m_axi_gmem_ARQOS(mac_1_m_axi_gmem_ARQOS),
        .m_axi_gmem_ARREADY(mac_1_m_axi_gmem_ARREADY),
        .m_axi_gmem_ARREGION(mac_1_m_axi_gmem_ARREGION),
        .m_axi_gmem_ARSIZE(mac_1_m_axi_gmem_ARSIZE),
        .m_axi_gmem_ARVALID(mac_1_m_axi_gmem_ARVALID),
        .m_axi_gmem_AWADDR(mac_1_m_axi_gmem_AWADDR),
        .m_axi_gmem_AWBURST(mac_1_m_axi_gmem_AWBURST),
        .m_axi_gmem_AWCACHE(mac_1_m_axi_gmem_AWCACHE),
        .m_axi_gmem_AWID(mac_1_m_axi_gmem_AWID),
        .m_axi_gmem_AWLEN(mac_1_m_axi_gmem_AWLEN),
        .m_axi_gmem_AWLOCK(mac_1_m_axi_gmem_AWLOCK),
        .m_axi_gmem_AWPROT(mac_1_m_axi_gmem_AWPROT),
        .m_axi_gmem_AWQOS(mac_1_m_axi_gmem_AWQOS),
        .m_axi_gmem_AWREADY(mac_1_m_axi_gmem_AWREADY),
        .m_axi_gmem_AWREGION(mac_1_m_axi_gmem_AWREGION),
        .m_axi_gmem_AWSIZE(mac_1_m_axi_gmem_AWSIZE),
        .m_axi_gmem_AWVALID(mac_1_m_axi_gmem_AWVALID),
        .m_axi_gmem_BID(mac_1_m_axi_gmem_BID),
        .m_axi_gmem_BREADY(mac_1_m_axi_gmem_BREADY),
        .m_axi_gmem_BRESP(mac_1_m_axi_gmem_BRESP),
        .m_axi_gmem_BVALID(mac_1_m_axi_gmem_BVALID),
        .m_axi_gmem_RDATA(mac_1_m_axi_gmem_RDATA),
        .m_axi_gmem_RID(mac_1_m_axi_gmem_RID),
        .m_axi_gmem_RLAST(mac_1_m_axi_gmem_RLAST),
        .m_axi_gmem_RREADY(mac_1_m_axi_gmem_RREADY),
        .m_axi_gmem_RRESP(mac_1_m_axi_gmem_RRESP),
        .m_axi_gmem_RVALID(mac_1_m_axi_gmem_RVALID),
        .m_axi_gmem_WDATA(mac_1_m_axi_gmem_WDATA),
        .m_axi_gmem_WLAST(mac_1_m_axi_gmem_WLAST),
        .m_axi_gmem_WREADY(mac_1_m_axi_gmem_WREADY),
        .m_axi_gmem_WSTRB(mac_1_m_axi_gmem_WSTRB),
        .m_axi_gmem_WVALID(mac_1_m_axi_gmem_WVALID),
  ...
  vitis_design_noc_ddr4_0 noc_ddr4
       (.CH0_DDR4_0_act_n(noc_ddr4_CH0_DDR4_0_ACT_N),
        ...
        .S00_AXI_araddr(mac_1_m_axi_gmem_ARADDR),
        .S00_AXI_arburst(mac_1_m_axi_gmem_ARBURST),
        .S00_AXI_arcache(mac_1_m_axi_gmem_ARCACHE),
        .S00_AXI_arid(mac_1_m_axi_gmem_ARID),
        .S00_AXI_arlen(mac_1_m_axi_gmem_ARLEN),
        .S00_AXI_arlock(mac_1_m_axi_gmem_ARLOCK[0]),
        .S00_AXI_arprot(mac_1_m_axi_gmem_ARPROT),
        .S00_AXI_arqos(mac_1_m_axi_gmem_ARQOS),
        .S00_AXI_arready(mac_1_m_axi_gmem_ARREADY),
        .S00_AXI_arregion(mac_1_m_axi_gmem_ARREGION),
        .S00_AXI_arsize(mac_1_m_axi_gmem_ARSIZE),
        .S00_AXI_arvalid(mac_1_m_axi_gmem_ARVALID),
        .S00_AXI_awaddr(mac_1_m_axi_gmem_AWADDR),
        .S00_AXI_awburst(mac_1_m_axi_gmem_AWBURST),
        .S00_AXI_awcache(mac_1_m_axi_gmem_AWCACHE),
        .S00_AXI_awid(mac_1_m_axi_gmem_AWID),
        .S00_AXI_awlen(mac_1_m_axi_gmem_AWLEN),
        .S00_AXI_awlock(mac_1_m_axi_gmem_AWLOCK[0]),
        .S00_AXI_awprot(mac_1_m_axi_gmem_AWPROT),
        .S00_AXI_awqos(mac_1_m_axi_gmem_AWQOS),
        .S00_AXI_awready(mac_1_m_axi_gmem_AWREADY),
        .S00_AXI_awregion(mac_1_m_axi_gmem_AWREGION),
        .S00_AXI_awsize(mac_1_m_axi_gmem_AWSIZE),
        .S00_AXI_awvalid(mac_1_m_axi_gmem_AWVALID),
        .S00_AXI_bid(mac_1_m_axi_gmem_BID),
        .S00_AXI_bready(mac_1_m_axi_gmem_BREADY),
        .S00_AXI_bresp(mac_1_m_axi_gmem_BRESP),
        .S00_AXI_bvalid(mac_1_m_axi_gmem_BVALID),
        .S00_AXI_rdata(mac_1_m_axi_gmem_RDATA),
        .S00_AXI_rid(mac_1_m_axi_gmem_RID),
        .S00_AXI_rlast(mac_1_m_axi_gmem_RLAST),
        .S00_AXI_rready(mac_1_m_axi_gmem_RREADY),
        .S00_AXI_rresp(mac_1_m_axi_gmem_RRESP),
        .S00_AXI_rvalid(mac_1_m_axi_gmem_RVALID),
        .S00_AXI_wdata(mac_1_m_axi_gmem_WDATA),
        .S00_AXI_wlast(mac_1_m_axi_gmem_WLAST),
        .S00_AXI_wready(mac_1_m_axi_gmem_WREADY),
        .S00_AXI_wstrb(mac_1_m_axi_gmem_WSTRB),
        .S00_AXI_wvalid(mac_1_m_axi_gmem_WVALID),
  ...
  vitis_design_psr_208mhz_0 psr_208mhz
       (.aux_reset_in(1'b1),
        ...
        .ext_reset_in(CIPS_0_pl_resetn1),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(clk_wizard_0_clk_out5));
  ...
  vitis_design_psr_416mhz_0 psr_416mhz
       (.aux_reset_in(1'b1),
        ...
        .ext_reset_in(CIPS_0_pl_resetn1),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(clk_wizard_0_clk_out6));
  vitis_design_psr_625mhz_0 psr_625mhz
       (.aux_reset_in(1'b1),
        .dcm_locked(clk_wizard_0_locked),
        .ext_reset_in(CIPS_0_pl_resetn1),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(clk_wizard_0_clk_out7));
  vitis_design_psr_78mhz_0 psr_78mhz
       (.aux_reset_in(1'b1),
        .dcm_locked(clk_wizard_0_locked),
        .ext_reset_in(CIPS_0_pl_resetn1),
        .mb_debug_sys_rst(1'b0),
        .slowest_sync_clk(clk_wizard_0_clk_out4));
