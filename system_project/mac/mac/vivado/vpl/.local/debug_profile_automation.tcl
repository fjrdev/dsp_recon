...
namespace eval dpa {
  ...
  proc add_hsdp_aie_trace_infrastructure_v2 {numStreams aieStreams dpa_opts} {
    ...
    set streamBits [expr 8 * $streamBytes]
    if {$streamBits != 64} {
        send_msg_id "101-1" "ERROR" "Only 64 bit wide AIE Trace PLIO is supported with HSDP Trace Offload."
        return
    }
    ...
    set_property CONFIG.S_AXI_DATA_WIDTH 64            $hsdp_trace_ip
  ...
  proc add_hsdp_pl_trace_infrastructure { masterClock masterReset traceHubName } {
    ...
    set_property CONFIG.T0_PKT_SIZE      64            $hsdp_trace_ip
    set_property CONFIG.T0_DATA_WIDTH    64            $hsdp_trace_ip
  ...
  proc add_hsdp_aie_pl_trace_infrastructure {dpa_opts} {
    ...
    set_property CONFIG.T1_DATA_WIDTH    64            $hsdp_trace_ip
