...
//------------------------Parameter----------------------
`define TV_IN_a "../tv/cdatafile/c.mac.autotvin_a.dat"
`define TV_IN_b "../tv/cdatafile/c.mac.autotvin_b.dat"
`define TV_IN_c "../tv/cdatafile/c.mac.autotvin_c.dat"
`define TV_IN_size "../tv/cdatafile/c.mac.autotvin_size.dat"
...
parameter mac_continue_addr = 0;
parameter mac_auto_start_addr = 0;
parameter a_data_in_addr = 16;
parameter b_data_in_addr = 28;
parameter c_data_in_addr = 40;
parameter size_data_in_addr = 52;
...
assign TRAN_control_write_data_finish = 1 & a_write_data_finish & b_write_data_finish & c_write_data_finish & size_write_data_finish;
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_c_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    write (c_data_in_addr + write_c_count * ceil_align_to_pow_of_two_four_byte_num * 4 + i * 4, c_data_tmp_reg, write_c_resp);
        ...
        if (ongoing_process_number === process_num && process_busy === 0 ) begin
            ...
            if (write_size_run_flag === 1 && get_ack === 1) begin
                ...
                for (i = 0 ; i < four_byte_num ; i = i+1) begin
                    ...
                    write (size_data_in_addr + write_size_count * ceil_align_to_pow_of_two_four_byte_num * 4 + i * 4, size_data_tmp_reg, write_size_resp);
